...
$xmlDoc->load('http://extratorrent.cc/rss.xml?cid=2&type=last');
...
for ($i=0; $i < $itemCount; $i++){
 ...
 $statement = $link->prepare("INSERT INTO `code1` (info_hash, name, filename, save_as, size, added, announce, descr, visible, external, category) VALUES ('$hash', '$name', '$filename', '$filename', '$siz', '$date', '$expld[1]', 'No description given.', 'yes', 'yes', '36')");
